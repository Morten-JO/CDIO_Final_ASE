...
public class JUnit_ProduktBatchKomp {
	...
	public void c_getProduktBatchKomp() {
		try {
			ProduktBatchKompDTO test = produktbatchkomp.getProduktBatchKomp(produktbatchkompDTO.getPbId(),
					produktbatchkompDTO.getRbId());
			if (test != null) {
	...
	public void d_updateProduktBatchKomp() {
		try {
			...
			ProduktBatchKompDTO temp = produktbatchkomp.getProduktBatchKomp(produktbatchkompDTO.getPbId(),
					produktbatchkompDTO.getRbId());
